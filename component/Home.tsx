...
const Home = () => {
  ...
  return (
    <section id="home" className="relative flex items-center justify-center min-h-screen overflow-hidden pt-28 md:pt-0 bg-gradient-to-br from-gray-900 to-black ">
      {/* Background */}
      <div className="absolute  bg-[url('/images/bg.png')] bg-cover bg-center blur-md  brightness-50 h-1/2 w-1/2 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="relative z-10 max-w-4xl px-4 mx-auto text-center">
        ...
        <div className="grid grid-cols-1 gap-8 mt-20 md:grid-cols-3">
          <div className="text-center">
            ...
            <h3 className="mb-2 text-xl font-semibold text-white">Professional Equipment</h3>
            <p className="text-gray-400">High-end amplifiers, drums, and recording gear</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="mb-2 text-xl font-semibold text-white">Perfect Acoustics</h3>
            <p className="text-gray-400">Soundproofed rooms designed for loud music.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="mb-2 text-xl font-semibold text-white">Band Friendly</h3>
            <p className="text-gray-400">Spacious rooms for full band practice sessions</p>
          </div>
        </div>
      </div>
    </section>
